...
def run_maniskill2_eval_single_episode(
    ...
    # pose_0 = np.concatenate([np.array(env.episode_objs[0].get_pose().p),
    #                      np.array(env.episode_objs[0].get_pose().q)])
    # pose_1 = np.concatenate([np.array(env.episode_objs[1].get_pose().p),
    #                      np.array(env.episode_objs[1].get_pose().q)])
    ...
    # raw_actions_path = video_path.replace(".mp4", "_raw_actions.npy")
    # actions_path = video_path.replace(".mp4", "_actions.npy")
    # pose_path = video_path.replace(".mp4", "_pose.npy")


    # np.save(pose_path, np.stack([pose_0, pose_1]))
    # np.save(raw_actions_path, np.array(raw_actions))
