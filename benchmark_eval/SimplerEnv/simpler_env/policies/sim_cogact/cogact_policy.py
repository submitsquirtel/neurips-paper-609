...
from simpler_env.policies.sim_cogact.CogACT.vla import load_vla
from simpler_env.policies.sim_cogact.CogACT.adaptive_ensemble import AdaptiveEnsembler
...
class CogACTInference:
    def __init__(
        ...
        print(action_model_type)
        print(future_action_window_size)
        self.vla = load_vla(
