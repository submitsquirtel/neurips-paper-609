...
def load_roma(args, test_orginal_megadepth=False):
    ...
    from src.utils.MINIMA.data_io_roma import DataIOWrapper, lower_config
...
def load_loftr(args, test_orginal_megadepth=False):
    ...
    if test_orginal_megadepth:
        ...
        from src.config.default import get_cfg_defaults
    from src.utils.MINIMA.data_io_loftr import DataIOWrapper, lower_config
    config = get_cfg_defaults(inference=True)
    config = lower_config(config)
...
def load_sp_lg(args, test_orginal_megadepth=False):
    ...
    if test_orginal_megadepth:
        ...
        from src.config.default import get_cfg_defaults
    from src.utils.MINIMA.data_io_sp_lg import DataIOWrapper, lower_config
...
def load_xoftr(args):
    ...
    from src.config.default import get_cfg_defaults
    from src.utils.MINIMA.data_io import DataIOWrapper, lower_config
    config = get_cfg_defaults(inference=True)
    config = lower_config(config)
